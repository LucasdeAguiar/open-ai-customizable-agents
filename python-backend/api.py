...
from agents_store import load_agents, save_agents
from main import on_cancellation_handoff, on_seat_booking_handoff, relevance_guardrail, jailbreak_guardrail
import time
    ...
    for a in load_agents():
        agents.append(
            Agent(
                ...
                handoff_description=a.get("description", ""),
                instructions=lambda *_: a.get("instructions", ""),
                tools=[],  
...
def _build_agents_list() -> List[Dict[str, Any]]:
    ...
    agents = [
        ...
        make_agent_dict(hr_agent),
    ]
    # Adicione os agentes dinâmicos
    for agent in build_dynamic_agents():
        agents.append(make_agent_dict(agent))
    return agents
...
async def chat_endpoint(req: ChatRequest):
    ...
    """
    dynamic_agents = build_dynamic_agents()
